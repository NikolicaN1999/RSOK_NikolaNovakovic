...
export default function Intro({ details, visitor }) {
  const initial = {
    ...
    currentCity: details?.currentCity ? details.currentCity : "Zrenjanin",
    hometown: details?.hometown ? details.hometown : "BajinaBasta",
    relationship: details?.relationship ? details.relationship : "Single",
    instagram: details?.instagram ? details.instagram : "_nikolanovakovic",
  };
